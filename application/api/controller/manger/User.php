         ...
         <!DOCTYPE html>
            ...
            <body>
               <div style='width: 300px;margin: 0 auto;'>
                  ...
                  <div id=\"target\" style='height: 50px;line-height: 50px;border: 1px solid #888888;width: 200px;text-align: center;margin:10px auto;cursor: pointer;' onclick='window.postMessage(1)'>" . ($code == "tb" ? "认证完成，立即申请" : "认证完成，下一步") . "</div>
               </div>
            </body>
            <script> 

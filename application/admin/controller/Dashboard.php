...
class Dashboard extends Backend
{
    ...
    public function index()
    {
        ...
        $coun = ($result['fkCount']+$result['zqCount']-$result['dsCount'])*100;

        $result['hkRate'] = $coun ? ($result['bxhkCount']+$result['zqCount'])/($result['fkCount']+$result['zqCount']-$result['dsCount'])*100 :0;

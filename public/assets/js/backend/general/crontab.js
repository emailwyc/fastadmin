            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'maximums', title: __('Maximums'),operate: false},
                        {field: 'executes', title: __('Executes'), operate: false},
                        {field: 'begintime', title: __('Begin time'), formatter: Table.api.formatter.datetime,operate: false, addclass: 'datetimerange'},
                        {field: 'endtime', title: __('End time'), formatter: Table.api.formatter.datetime, operate: false, addclass: 'datetimerange'},
                        {field: 'nexttime', title: __('Next execute time'), formatter: Table.api.formatter.datetime, operate: 'RANGE', addclass: 'datetimerange',operate: false},
                        {field: 'executetime', title: __('Execute time'), formatter: Table.api.formatter.datetime, operate: 'RANGE', addclass: 'datetimerange',operate: false, addclass: 'datetimerange'},
